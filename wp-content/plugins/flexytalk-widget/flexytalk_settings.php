<?php 
	...
	if(isset($_POST['flexytalk_hidden']) and ($_POST['flexytalk_hidden'] == 'Y')) {
...
?>
		<div><p><strong><?php echo($message ); ?></strong></p></div>
<?php
	}
	else {
	...
	<table class="wc_status_table widefat" cellspacing="0">
			...
			<tbody>
                <tr>
                    ...
                    <td><i> Signup for a FREE 14-days trial. Afer the trial you can renew your plan with a monthly or annual payment (discount) or downgrade your account to our Free Plan.  </i></td>
